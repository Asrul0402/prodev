...
// perubahan data form
Route::post('jenismenu','admin\dataController@jenismenu')->name('jenismenu');
Route::get('openjenis/{id_jenis}','admin\dataController@openjenis')->name('openjenis');
Route::get('blokjenis/{id_jenis}','admin\dataController@blokjenis')->name('blokjenis');
Route::get('editform2','admin\dataController@formkat')->name('editform2');
Route::get('editform1','admin\dataController@formjenis')->name('editform1');
Route::get('editform3','admin\dataController@formsub')->name('editform3');
Route::get('openkat/{id}','admin\dataController@openkat')->name('openkat');

Route::get('blokkat/{id}','admin\dataController@blokkat')->name('blokkat');
Route::get('opensub/{id_subkategori}','admin\dataController@opensub')->name('opensub');
Route::get('bloksub/{id_subkategori}','admin\dataController@bloksub')->name('bloksub');
Route::get('getdata/{id_jenis}','admin\dataController@getdata')->name('getdata');

Route::get('akses','admin\dataController@akses')->name('akses');
Route::post('menu','admin\dataController@tambahmenu')->name('menu');
Route::get('datases','admin\ApprovalController@datases')->name('datases');
Route::post('ses','admin\ApprovalController@ses')->name('ses');
Route::get('hapuspesan/{id}','pv\pkpController@hapuspesan')->name('hapuspesan');
...
Route::post('tambahsub','admin\dataController@tambahsub')->name('tambahsub');
Route::post('tambahkat','admin\dataController@tambahkategori')->name('tambahkate');
Route::post('tambahjenis','admin\dataController@tambahjenis')->name('tambahjenis');
Route::post('editjenis/{id_jenis}','admin\dataController@editjenis')->name('editjenis');
Route::post('editkat/{id}','admin\dataController@editkat')->name('editkat');
Route::post('editsub/{id}','admin\dataController@editsub')->name('editsub');
/* Data PKP dan PDF */
Route::get('dataPKPPDF','admin\ApprovalController@data')->name('dataPKPPDF'); 
...
Route::get('notulenpromo','pv\pkp2Controller@notulenpromo')->name('notulenpromo');
...
Route::get('tambahdata','admin\dataController@tambahdata')->name('tambahdata');
Route::get('temppkp/{id}','pv\pkp2Controller@template')->name('temppkp');

Route::get('konfigurasi/{id}/{turunan}','pv\pkpController@konfigurasi')->name('konfigurasi');
...
Route::post('updatest1/{id_project}/{revisi}/{id}','pv\pkpController@updatest1')->name('updatest1');
Route::post('updatest2/{id_project}','pv\pkpController@updatest2')->name('updatest2');
...
Route::post('editpromo1/{id_pkp_promo}','pv\promoController@editpromo1')->name('editpromo1');
Route::post('editpromo11/{id_pkp_promo}/{revisi}/{turunan}','pv\promoController@editpromo11')->name('editpromo11');
...
Route::post('pertama/{id}','pv\pdfController@updatepertama')->name('pertama');
Route::post('pertamaa/{id}/{revisi}/{turunan}','pv\pdfController@updatepertamaa')->name('pertamaa');
...
Route::get('hapuslaunch/{id}/{turunan}','pv\pkpController@deletelaunch')->name('hapuslaunch');
