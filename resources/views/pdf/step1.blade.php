          ...
          <div class="x_content">
            <div class="col-md-12 col-xs-12">
              ...
              <div class="form-group row">
                ...
                <div class="col-md-9 col-sm-9 col-xs-12">
                  <input id="author" disabled value="{{$kode}}/PDF_{{ $pdf->project_name }}_{{ $pdf->id_brand }}" class="form-control col-md-12 col-xs-12" type="text" name="author">
                </div>
              </div>
            </div>
          </div>
    ...
    <div class="col-md-6 col-xs-12">
      <div class="x_panel" style="min-height:320px">
        ...
        <div class="form-group row">
          ...
          <div class="col-md-9 col-sm-9 col-xs-12">
            <input id="author" disabled value="{{ $pdf->author }}" class="form-control col-md-12 col-xs-12" type="text" name="author">
          </div>
        </div>
				 <?php $date = Date('j-F-Y'); ?>
        <div class="form-group row">
          ...
          <div class="col-md-9 col-sm-9 col-xs-12">
            <input id="perevisi" value="{{ Auth::user()->name }}" readonly class="form-control col-md-12 col-xs-12" type="text" name="perevisi">
