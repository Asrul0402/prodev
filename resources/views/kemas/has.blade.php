...
<div class="panel-body badan">
	...
	<table class="table-sm table-responsive table-hover table-bordered" style="font-size: 11px;">
		<thead>
			<tr>
		...
		<a href="{{ route('myFeasibility',$id_feasibility) }}" class="btn btn-info" type="submit">Selesai</a>
          ...
          <div role="tabpanel" class="tab-pane fade" id="tab_content2" aria-labelledby="profile-tab">
					...
					<div class="panel-body badan">
						...
						<table class="table-sm table-responsive table-bordered" style="font-size: 12px;">
							<thead>
								<tr>
