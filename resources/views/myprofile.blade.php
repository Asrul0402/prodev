...
<div class="col-md-12" >
  <ul class="breadcrumb">
    <li class="breadcrumb-item" style="padding-left:1150px">
      <a href="{{route('lala')}}"> <i class="fa fa-home"></i> </a>
    </li>
    ...
    <div class="x_content">
      <div class="col-md-3 col-sm-3 col-xs-12 profile_left">
        <div class="profile_img">
          <div id="crop-avatar">
            <!-- Current avatar -->
            <img class="img-responsive avatar-view" src="../img/prodev.png" alt="Avatar" title="Change the avatar">
          </div>
        </div>
        <h3 class="text-center">{{ Auth::user()->name }}</h3>
        <h6 class="text-center">Last update : {{ $users->updated_at}}</h6>
        <center><button class="btn btn-info"><li class="fa fa-check"></li> Active</button></center>
      </div>
