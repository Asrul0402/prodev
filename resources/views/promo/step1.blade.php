          ...
          <div class="x_content">
            <div class="col-md-12 col-xs-12">
              ...
              <div class="form-group row">
                ...
                <div class="col-md-9 col-sm-9 col-xs-12">
                  <input id="author" disabled value="{{$kode}}/PKP_{{ $pkp->project_name }}_{{ $pkp->id_brand }}_{{ $pkp->revisi }}.{{ $pkp->turunan }}" class="form-control col-md-12 col-xs-12" type="text" name="author">
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="x_panel" style="min-height:280px">
        <div class="x_title">
          ...
          <div class="form-group row">
            ...
            <div class="col-md-9 col-sm-9 col-xs-12">
              <input id="author" disabled value="{{ $pkp->Author }}" class="form-control col-md-12 col-xs-12" type="text" name="author">
            </div>
          </div>
				  <?php
          $last = Date('j-F-Y');
          ...
          <div class="form-group row">
            ...
            <div class="col-md-9 col-sm-9 col-xs-12">
              <input id="perevisi" readonly value="{{ Auth::user()->name }}" class="form-control col-md-12 col-xs-12" type="text" name="perevisi">
