...
<div class="col-md-12 col-sm-12 col-xs-12">
  <div class="x_panel" style="min-height:466px">
    <div class="x_title">
      <h3><li class="fa fa-edit"></li> Project PROMO</h3>
    </div>
    <div class="x_content">
      @if (session('status'))
            ...
            <table class="Table table-bordered">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  @elseif($Dpromo->form2=='')
                    <select style="display:none;" name="datapromo[{{$loop->index}}][brand]" class="form-control">
                      <option value="{{$Dpromo->brand}}">{{$Dpromo->brand}}</option>
                      @foreach($brand as $br)
                      <option value="{{$br->brand}}">{{$br->brand}}</option>
                      @endforeach
                  ...
                  @elseif($Dpromo->form3=='')
                    <select style="display:none;" name="datapromo[{{$loop->index}}][type]" class="form-control">
                      <option value="{{$Dpromo->type}}" readonly>
                        @if($Dpromo->type==1)
                        Maklon
                        @elseif($Dpromo->type==2)
                  ...
                  <td><textarea name="note[{{$loop->index}}][note]" clas="col-md-12 col-sm-12 col-xs-12" value="{{$Dpromo->note}}" rows="3">{{$Dpromo->note}}</textarea></td>
                </tr>
                 @endforeach
              </tbody>
            </table>
