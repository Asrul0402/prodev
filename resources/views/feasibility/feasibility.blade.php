...
<div class="col-md-1"><h4>
            ...
            <a data-toggle="dropdown" class="dropdown-toggle">
              ...
              @foreach($dataF as $dF)
                <a href="{{ route('inboxproduksi',['id_feasibility' => $dF->id_feasibility, 'id_formula' => $dF->id_formula]) }}">See all messages
                  </a>@endforeach
              </li>
            </ul>
          </li>
          ...
          @if(auth()->user()->role->namaRule === 'evaluator')
            <a data-toggle="dropdown" class="dropdown-toggle">
              ...
              <li class="text-center">
              @foreach($dataF as $dF)
                <a href="{{ route('inboxmesin',['id_feasibility' => $dF->id_feasibility, 'id_formula' => $dF->id_formula]) }}">See all messages
                  </a>@endforeach
              </li>
            </ul>
          </li>
          ...
          @if(auth()->user()->role->namaRule === 'lab')
            <a data-toggle="dropdown" class="dropdown-toggle">
              ...
              <li class="text-center">
              @foreach($dataF as $dF)
                <a href="{{ route('inboxlab',['id_feasibility' => $dF->id_feasibility, 'id_formula' => $dF->id_formula]) }}">See all messages
                  </a>@endforeach
              </li>
            </ul>
          </li>
          ...
          @if(auth()->user()->role->namaRule === 'kemas')
            <a data-toggle="dropdown" class="dropdown-toggle">
              ...
              <li class="text-center">
              @foreach($dataF as $dF)
                <a href="{{ route('inboxkemas',['id_feasibility' => $dF->id_feasibility, 'id_formula' => $dF->id_formula]) }}">See all messages
                  </a>@endforeach
              </li>
            </ul>
          </li>
