...
<div class="row">
        ...
        <div class="tabbable">
            <ul class="nav nav-tabs wizard">
                ...
                <li class="active"><a href="{{ route('step2',$idf) }}"><span class="nmbr">3</span>Data Panel</a></li>
                <li class="completed"><a href="{{ route('step3',$idf) }}"><span class="nmbr">4</span>Premixs</a></li>
            </ul>
        </div>
        </div>
</div>
