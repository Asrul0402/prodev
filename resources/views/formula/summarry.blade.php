...
<div class="row">
        ...
        <div class="tabbable">
            <ul class="nav nav-tabs wizard">
                ...
                <li class="completed"><a href="{{ route('summarry',$idf) }}"><span class="nmbr">3</span>Summary</a></li>
...
<label>PT NUTRIFOOD INDONESIA</label>
  ...
  <table class="table table-bordered" style="font-size:12px">
                                                            <thead style="background-color:#ddd;font-weight: bold;color:black;">
                                                                    <tr>
  ...
  <table ALIGN="right" class="table-bordered">
    ...
    <tbody>
      ...
      <tr>
        ...
        <table>
        <tr>*) Ditandatangani jika perubahan formula berasal/ diajukan oleh RD sourcing</tr></table>
</div>
</div>
                            @endif
                        </div>
