...
<div class="col-md-9 col-sm-9 col-xs-12 card">
  <div class="card-header">
    <h5>Analisa</h5>
      ...
      <form action="{{ route('labb') }}" method="post">
        ...
        <div class="col-md-1 col-sm-1 col-xs-12">
          <input type="hidden" name="finance" maxlength="45" required="required" value="{{$fe->id_feasibility}}" class="form-control col-md-7 col-xs-12">
            ...
            <td><select class="form-control" name="kode_{{ $key }}" id="kode">
            <option value="">---</option>
      ...
      <button id="btnAdd" class="button-add btn btn-info btn-sm fa fa-plus" onclick="insertRow();"> Tambah Analisa</button>
    <br>
    </div>
    @elseif($count_lab != 0)
    <table id="myTable" class="table table-hover table-bordered">
