    ...
    <section class="panel">
      ...
      <div class="panel-body">
        <div class="compose-mail">
          <form role="form-horizontal" method="post" action="{{ route('Pkemas',['id_feasibility' => $dF->id_feasibility, 'id_formula' => $dF->id_formula]) }}">
            <div class="form-group">
              <label for="to" class="">To:</label>
              <div class="col-md-10 col-sm-11 col-xs-12">
                <input type="text" name="finance" maxlength="45" required="required" value="kemas" class="form-control1 col-md-7 col-xs-12" disabled>
              </div>
            </div>
