...
<div class="col-sm-3">
    ...
    <section class="panel">
      <div class="panel-body">
      @foreach($dataF as $dF)
        <a href="{{ route('inboxfn',['id_feasibility' => $dF->id_feasibility, 'id_formula' => $dF->id_formula]) }}" type="submit" class="btn btn-compose btn-lg btn-block" disable>
    ...
    <section class="panel">
      ...
      <div class="panel-body">
        <div class="compose-mail">
          <form role="form-horizontal" method="post" action="{{ route('insertkomentar',['id_feasibility' => $dF->id_feasibility, 'id_formula' => $dF->id_formula]) }}">
          <div class="form-group">
            <label for="to" class="">To:</label>
              <input type="text" name="user" maxlength="45" required="required" value="Evaluator" class="form-control1 col-md-7 col-xs-12" disabled>
          </div>
