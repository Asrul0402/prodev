...
<div class="col-md-12 col-sm-12 col-xs-12">
  <div class="x_panel" style="min-height:496px">
    <div class="x_title">
      <h3><li class="fa fa-edit"></li> Project PKP</h3>
    </div>
    <div class="x_content">
              ...
              <table class="Table table-bordered">
                ...
                <tbody>
                  ...
                  <tr>
                      ...
                      <input type="hidden" name="scores[{{$loop->index}}][primary]" value="{{$Dpkp->primary}}" class="form-control">
                    ...
                    @if($Dpkp->form1=='ya')<td><input type="text" name="scores[{{$loop->index}}][name]" class="form-control" value="{{$Dpkp->project_name}}">
                    ...
                    @if($pr->form15=='ya')<td>
                      <select class="form-control" name="scores[{{$loop->index}}][uom]">
                        <option value="{{$Dpkp->datauom->id}}">{{$Dpkp->datauom->primary_uom}}</option>
                        @foreach($uom as $Duom)
                        <option value="{{$Duom->id}}">{{$Duom->primary_uom}}</option>
                        @endforeach
                      </select>
                      @elseif($pr->form15=='')<select style="display:none;" class="form-control" name="scores[{{$loop->index}}][uom]">
                        <option value="{{$Dpkp->datauom->id}}">{{$Dpkp->datauom->primary_uom}}</option>
                        @foreach($uom as $Duom)
                        <option value="{{$Duom->id}}">{{$Duom->primary_uom}}</option>
                        @endforeach
                    ...
                    <td width="90px"><textarea cols="30" name="note[{{$loop->index}}][note]" class="col-md-12 col-sm-12 col-xs-12" value="{{$Dpkp->note}}" rows="3"></textarea></td>
                  </tr>
                  @endforeach
                </tbody>
              </table>
              @foreach($datapkp as $Dpkp)
              <input type="hidden" name="scores1[{{$loop->index}}][id_pkp]" value="{{$Dpkp->id_pkp}}">
                      <input type="hidden" name="scores1[{{$loop->index}}][turun]" value="{{$Dpkp->turunan}}" class="form-control">
                      <input type="hidden" name="scores1[{{$loop->index}}][rev]" value="{{$Dpkp->revisi}}" class="form-control">
                      <input type="hidden" name="scores1[{{$loop->index}}][revisi]" value="{{$Dpkp->revisi+1}}" class="form-control">
                      <input type="hidden" name="scores1[{{$loop->index}}][status]" value="inactive" class="form-control">
                      <input type="hidden" name="scores1[{{$loop->index}}][launch]" value="{{$Dpkp->launch}}" class="form-control">
                      <input type="hidden" name="scores1[{{$loop->index}}][years]" value="{{$Dpkp->years}}" class="form-control">
                      <input type="hidden" name="scores1[{{$loop->index}}][tgl]" value="{{$Dpkp->tgl_launch}}" class="form-control">
                      <input type="hidden" name="scores1[{{$loop->index}}][bpom]" value="{{$Dpkp->bpom}}" class="form-control">
                      <input type="hidden" name="scores1[{{$loop->index}}][katbpom]" value="{{$Dpkp->kategori_bpom}}" class="form-control">
                      <input type="hidden" name="scores1[{{$loop->index}}][olahan]" value="{{$Dpkp->olahan}}" class="form-control">
                      <input type="hidden" name="scores1[{{$loop->index}}][primer]" value="{{$Dpkp->primer}}" class="form-control">
                      <input type="hidden" name="scores1[{{$loop->index}}][primary]" value="{{$Dpkp->primary}}" class="form-control">
                      <input type="hidden" name="scores1[{{$loop->index}}][secondary]" value="{{$Dpkp->secondary}}" class="form-control">
                      <input type="hidden" name="scores1[{{$loop->index}}][tertiary]" value="{{$Dpkp->tertiary}}" class="form-control">
                      <input type="hidden" name="scores1[{{$loop->index}}][eksis]" value="{{$Dpkp->kemas_eksis}}" class="form-control">
                      <input type="hidden" name="scores1[{{$loop->index}}][proses]" value="{{$Dpkp->gambaran_proses}}" class="form-control">
                      <input type="hidden" name="scores1[{{$loop->index}}][data]" value="sent" class="form-control">
                      <?php $tanggal = Date("Y"); ?>
                      @if($Dpkp->jenis!='Umum')
                        @if($Dpkp->type=='Maklon')
                        <input type="hidden" value="_{{$tanggal}}/PKP{{$Dpkp->jenis}}-M_{{ $Dpkp->project_name }}_{{ $Dpkp->revisi+1 }}.{{ $Dpkp->turunan }}" name="scores1[{{$loop->index}}][ket]" id="ket_no">
                        @elseif($Dpkp->type!='Maklon')
                        <input type="hidden" value="_{{$tanggal}}/PKP{{$Dpkp->jenis}}_{{ $Dpkp->project_name }} _{{ $Dpkp->revisi+1 }}.{{ $Dpkp->turunan }}" name="scores1[{{$loop->index}}][ket]" id="ket_no">
                        @endif
                      @elseif($Dpkp->jenis=='Umum')
                        @if($Dpkp->type=='Maklon')
                        <input type="hidden" value="_{{$tanggal}}/PKP-M_{{ $Dpkp->project_name }}_{{ $Dpkp->revisi+1 }}.{{ $Dpkp->turunan }}" name="scores1[{{$loop->index}}][ket]" id="ket_no">
                        @elseif($Dpkp->type!='Maklon')
                        <input type="hidden" value="_{{$tanggal}}/PKP_{{ $Dpkp->project_name }} _{{ $Dpkp->revisi+1 }}.{{ $Dpkp->turunan }}" name="scores1[{{$loop->index}}][ket]" id="ket_no">
                        @endif
                      @endif
                    
                    @if($Dpkp->form1=='ya')<input type="hidden" name="scores1[{{$loop->index}}][name]" class="form-control" value="{{$Dpkp->project_name}}">
                    @elseif($Dpkp->form1=='')<input type="hidden" name="scores1[{{$loop->index}}][name]" class="form-control" value="{{$Dpkp->project_name}}"> @endif 
                    @if($Dpkp->form2=='ya')
                      <select style="display:none;" name="scores1[{{$loop->index}}][brand]" class="form-control">
                        <option value="{{$Dpkp->id_brand}}">{{$Dpkp->id_brand}}</option>
                        @foreach($brand as $br)
                        <option value="{{$br->brand}}">{{$br->brand}}</option>
                        @endforeach
                      ...
                      @elseif($Dpkp->form2=='')
                      <select style="display:none;" name="scores[{{$loop->index}}][brand]" class="form-control">
                        <option value="{{$Dpkp->id_brand}}">{{$Dpkp->id_brand}}</option>
                        @foreach($brand as $br)
                        <option value="{{$br->brand}}">{{$br->brand}}</option>
                        @endforeach
                    ...
                    @endif 
                    @if($Dpkp->form3=='ya')
                      <select style="display:none;" name="scores1[{{$loop->index}}][type]" class="form-control">
                        <option value="{{$Dpkp->type}}" readonly>
                          @if($Dpkp->type==1)
                          Maklon
                          @elseif($Dpkp->type==2)
                      ...
                      @elseif($Dpkp->form3=='')
                      <select name="scores1[{{$loop->index}}][type]" style="display:none;" class="form-control">
                        <option value="{{$Dpkp->type}}" readonly>
                          @if($Dpkp->type==1)
                          Maklon
                          @elseif($Dpkp->type==2)
                    ...
                    @endif
                    @if($pr->form4=='ya')<input type="hidden" name="scores1[{{$loop->index}}][idea]" class="form-control" value="{{$Dpkp->idea}}">
                    @elseif($pr->form4=='')<input type="hidden" name="scores1[{{$loop->index}}][idea]" class="form-control" value="{{$Dpkp->idea}}">@endif
                    @if($pr->form5=='ya')<input type="hidden" name="scores1[{{$loop->index}}][dariumur]" class="form-control" value="{{$Dpkp->dariumur}}">
                    @elseif($pr->form5=='')<input type="hidden" name="scores1[{{$loop->index}}][dariumur]" class="form-control" value="{{$Dpkp->dariumur}}">@endif
                    @if($pr->form5=='ya')<input type="hidden" name="scores1[{{$loop->index}}][sampaiumur]" class="form-control" value="{{$Dpkp->sampaiumur}}">
                    @elseif($pr->form5=='')<input type="hidden" name="scores1[{{$loop->index}}][sampaiumur]" class="form-control" value="{{$Dpkp->sampaiumur}}">@endif
                    @if($pr->form6=='ya')
                      <select class="form-control" style="display:none;" name="scores1[{{$loop->index}}][gender]">
                        <option value="{{$Dpkp->gender}}">{{$Dpkp->gender}}</option>
                        <option value="Male">Male</option>
                        <option value="Female">Female</option>
                        <option value="Male & Female">Male & Female</option>
                      ...
                      @elseif($pr->form6=='')
                      <select style="display:none;" class="form-control" name="scores1[{{$loop->index}}][gender]">
                        <option value="{{$Dpkp->gender}}">{{$Dpkp->gender}}</option>
                        <option value="Male">Male</option>
                        <option value="Female">Female</option>
                        <option value="Male & Female">Male & Female</option>
                    ...
                    @endif
                    @if($pr->form7=='ya')<input type="hidden" value="{{$Dpkp->Uniqueness}}" class="form-control" name="scores1[{{$loop->index}}][uniq]">
                    @elseif($pr->form7=='')<input type="hidden" value="{{$Dpkp->Uniqueness}}" class="form-control" name="scores1[{{$loop->index}}][uniq]">@endif
                    @if($pr->form8=='ya')<input type="hidden" value="{{$Dpkp->Estimated}}" class="form-control" name="scores1[{{$loop->index}}][estimated]">
                    @elseif($pr->form8=='')<input type="hidden" value="{{$Dpkp->Estimated}}" class="form-control" name="scores1[{{$loop->index}}][estimated]">@endif
                    @if($pr->form9=='ya')<input type="hidden" value="{{$Dpkp->reason}}" class="form-control" name="scores1[{{$loop->index}}][reason]">
                    @elseif($pr->form9=='')<input type="hidden" value="{{$Dpkp->reason}}" class="form-control" name="scores1[{{$loop->index}}][reason]">@endif
                    @if($pr->form10=='ya')<input type="hidden" value="{{$Dpkp->aisle}}" class="form-control" name="scores1[{{$loop->index}}][aisle]">
                    @elseif($pr->form10=='')<input type="hidden" value="{{$Dpkp->aisle}}" class="form-control" name="scores1[{{$loop->index}}][aisle]">@endif
                    @if($pr->form11=='ya')<input type="hidden" value="{{$Dpkp->price}}" class="form-control" name="scores1[{{$loop->index}}][price]">
                    @elseif($pr->form11=='')<input type="hidden" value="{{$Dpkp->price}}" class="form-control" name="scores1[{{$loop->index}}][price]">@endif
                    @if($pr->form12=='ya')<input type="hidden" value="{{$Dpkp->selling_price}}" class="form-control" name="scores1[{{$loop->index}}][selling]">
                    @elseif($pr->form12=='')<input type="hidden" value="{{$Dpkp->selling_price}}" class="form-control" name="scores1[{{$loop->index}}][selling]"> @endif
                    @if($pr->form13=='ya')<input type="hidden" value="{{$Dpkp->competitor}}" class="form-control" name="scores1[{{$loop->index}}][competitor]">
                    @elseif($pr->form13=='')<input type="hidden" value="{{$Dpkp->competitor}}" class="form-control" name="scores1[{{$loop->index}}][competitor]">@endif
                    @if($pr->form14=='ya')<input type="hidden" value="{{$Dpkp->competitive}}" class="form-control" name="scores1[{{$loop->index}}][competitive]">
                    @elseif($pr->form14=='')<input type="hidden" value="{{$Dpkp->competitive}}" class="form-control" name="scores1[{{$loop->index}}][competitive]">@endif
                    @if($pr->form15=='ya')
                      <select class="form-control" style="display:none;" name="scores1[{{$loop->index}}][uom]">
                        <option value="{{$Dpkp->datauom->id}}">{{$Dpkp->datauom->primary_uom}}</option>
                        @foreach($uom as $Duom)
                        <option value="{{$Duom->id}}">{{$Duom->primary_uom}}</option>
                        @endforeach
                      ...
                      @elseif($pr->form15=='')
                      <select style="display:none;" class="form-control" name="scores1[{{$loop->index}}][uom]">
                        <option value="{{$Dpkp->datauom->id}}">{{$Dpkp->datauom->primary_uom}}</option>
                        @foreach($uom as $Duom)
                        <option value="{{$Duom->id}}">{{$Duom->primary_uom}}</option>
                        @endforeach
                    ...
                    @endif
                    @if($pr->form16=='ya')<input type="hidden" value="{{$Dpkp->product_form}}" class="form-control" name="scores1[{{$loop->index}}][form]">
                    @elseif($pr->form16=='')<input type="hidden" value="{{$Dpkp->product_form}}" class="form-control" name="scores1[{{$loop->index}}][form]">@endif
                    @if($pr->form17=='ya')
                      <select class="form-control" style="display:none;" name="scores1[{{$loop->index}}][tarkon]">
                        <option value="{{$Dpkp->datatarkon->id_tarkon}}">{{$Dpkp->datatarkon->tarkon}}</option>
                        @foreach($tarkon as $Dtarkon)
                        <option value="{{$Dtarkon->id_tarkon}}">{{$Dtarkon->tarkon}}</option>
                        @endforeach
                      ...
                      @elseif($pr->form17=='')
                      <select style="display:none;" class="form-control" name="scores1[{{$loop->index}}][tarkon]">
                        <option value="{{$Dpkp->datatarkon->id_tarkon}}">{{$Dpkp->datatarkon->tarkon}}</option>
                        @foreach($tarkon as $Dtarkon)
                        <option value="{{$Dtarkon->id_tarkon}}">{{$Dtarkon->tarkon}}</option>
                        @endforeach
                    ...
                    @endif 
                    @if($pr->form18=='ya')<input type="hidden" value="{{$Dpkp->prefered_flavour}}" class="form-control" name="scores1[{{$loop->index}}][prefered]">
                    @elseif($pr->form18=='')<input type="hidden" value="{{$Dpkp->prefered_flavour}}" class="form-control" name="scores1[{{$loop->index}}][prefered]">@endif
                    @if($pr->form19=='ya')<input type="hidden" value="{{$Dpkp->product_benefits}}" class="form-control" name="scores1[{{$loop->index}}][benefits]">
                    @elseif($pr->form19=='')<input type="hidden" value="{{$Dpkp->product_benefits}}" class="form-control" name="scores1[{{$loop->index}}][benefits]">@endif
                    @if($pr->form20=='ya')<input type="hidden" value="{{$Dpkp->mandatory_ingredient}}" class="form-control" name="scores1[{{$loop->index}}][ingredient]">
                    @elseif($pr->form20=='')<input type="hidden" value="{{$Dpkp->mandatory_ingredient}}" class="form-control" name="scores1[{{$loop->index}}][ingredient]">@endif
              @endforeach
