			...
			<table class="Table table-bordered">
              ...
              @endif
						...
						<td class="text-center">
							@if($ps->status=='active')
							@if($ps->id_pkp!=NULL)
							<a href="{{route('bacapesan',$ps->id)}}" class="btn btn-info btn-sm"><li class="fa fa-eye"></li></a>
							@elseif($ps->id_pdf!=NULL)
							<a href="{{route('bacapesan',$ps->id)}}" class="btn btn-info btn-sm"><li class="fa fa-eye"></li></a>
							@elseif($ps->id_promo!=NULL)
							<a href="{{route('bacapesan',$ps->id)}}" class="btn btn-info btn-sm"><li class="fa fa-eye"></li></a>
							@endif
							@endif
							<a href="{{route('hapuspesan',$ps->id)}}" class="btn btn-danger btn-sm"><li class="fa fa-trash"></li></a>
						</td>
					</tr>
					@endforeach
				</tbody>
