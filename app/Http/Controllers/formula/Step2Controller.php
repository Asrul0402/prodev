...
class Step2Controller extends Controller
{
    ...
    public function create($id){
        ...
        $wb = Workbook::where('id',$formula->workbook_id)->first();
        $target_serving = $wb->target_serving;
    ...
    //     }
        ...
        return redirect()->route('step2',$formula->id)->with('status','BahanBaku Berhasil Ditambahkan');
    }
